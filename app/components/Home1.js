            ...
            <nav className="navbar navbar-inverse">
              <div className="container-fluid">
                ...
                <ul className="nav navbar-nav navbar-right">
                  <li><a href="#">Wes Warren</a></li>
                  <li><a href="#"><img src="./images/profile.jpeg" width={35} height={35} className="img img-circle" /></a></li>
                  <li>
                    <a href="#" className="navbar-toggle" onclick="openNav()">
