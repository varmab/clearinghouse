...
class Admin2 extends React.Component {
  ...
  changeTab(id, e) {
    $(".headerTabs").removeClass("headerTabActive");
    $(".adminTabContents").removeClass("activeAdminTabContent");

    $("#headerTab"+id).addClass("headerTabActive");
    $("#adminTabContent"+id).addClass("activeAdminTabContent");
  }
    ...
    return (
      <div>
        ...
        <div id="main" className="page-content">
          ...
          <div className="mypage-header"  style={{backgroundColor: "#C1A236", height: "268px"}}>
            ...
            <div className="container mypage-content">
              ...
              <center className="row">
                ...
                <div className="col-md-1 headerTabs" id="headerTab1" onClick={this.changeTab.bind(this, "1")}>
                  <div className="headerTabContent">Name</div>
                </div>
                <div className="col-md-1 headerTabs headerTabActive" id="headerTab2"  onClick={this.changeTab.bind(this, "2")}>
                  <div className="headerTabContent">URLs</div>
                </div>
                <div className="col-md-1 headerTabs" id="headerTab3"  onClick={this.changeTab.bind(this, "3")}>
                  <div className="headerTabContent">3rd Party</div>
                </div>
                <div className="col-md-1 headerTabs" id="headerTab4"  onClick={this.changeTab.bind(this, "4")}>
          ...
          <div className="container" style={{marginTop: 60}}>
            ...
            <div className="adminTabContents" id="adminTabContent1">
              <center style={{fontSize: "20px"}}>
                Name Tab
              </center>
            </div>

            <div className="adminTabContents activeAdminTabContent" id="adminTabContent2">
            ...
            <div className="adminTabContents" id="adminTabContent3">
              <center style={{fontSize: "20px"}}>
                3rd Party Tab
              </center>
            </div>

            <div className="adminTabContents" id="adminTabContent4">
              <center style={{fontSize: "20px"}}>
                All Tab
              </center>
            </div>
